...
if($action == 'listar'){
	...
	$campos = " c.id, c.apellido, c.nombres, c.dni, c.direccion, c.telefono, c.email, c.localidad_id, l.nombre as interesado_localidad, p.nombre as interesado_provincia ";
	if ($id) $andX[] = 'c.id = "' . $id .'"';
